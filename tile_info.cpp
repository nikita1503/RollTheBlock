...
void initalise_tile_for_levels()
{
    ...
    tile_for_level[2][1][2]=1;
    tile_for_level[2][1][3]=1;
    tile_for_level[2][1][4]=0;
    tile_for_level[2][1][5]=0;
    ...
    tile_for_level[2][2][1]=1;
    tile_for_level[2][2][2]=0;
    tile_for_level[2][2][3]=1;
    tile_for_level[2][2][4]=1;
    tile_for_level[2][2][5]=0;
    tile_for_level[2][2][6]=1;
    tile_for_level[2][2][7]=1;
    tile_for_level[2][2][8]=0;
    tile_for_level[2][2][9]=1;
    tile_for_level[2][2][10]=1;

    tile_for_level[2][3][1]=0;
    tile_for_level[2][3][2]=0;
    tile_for_level[2][3][3]=1;
    tile_for_level[2][3][4]=1;
    tile_for_level[2][3][5]=1;
    tile_for_level[2][3][6]=1;
    tile_for_level[2][3][7]=1;
    tile_for_level[2][3][8]=1;
    tile_for_level[2][3][9]=1;
    tile_for_level[2][3][10]=1;

    tile_for_level[2][4][1]=0;
    tile_for_level[2][4][2]=1;
    tile_for_level[2][4][3]=1;
    tile_for_level[2][4][4]=1;
    tile_for_level[2][4][5]=1;
    tile_for_level[2][4][6]=2;
    tile_for_level[2][4][7]=1;
    tile_for_level[2][4][8]=1;
    tile_for_level[2][4][9]=0;
    tile_for_level[2][4][10]=0;

    tile_for_level[2][5][1]=1;
    tile_for_level[2][5][2]=1;
    tile_for_level[2][5][3]=1;
    tile_for_level[2][5][4]=1;
    tile_for_level[2][5][5]=1;
    tile_for_level[2][5][6]=1;
    tile_for_level[2][5][7]=0;
    tile_for_level[2][5][8]=0;
    tile_for_level[2][5][9]=1;
    tile_for_level[2][5][10]=0;

    tile_for_level[2][6][1]=1;
    tile_for_level[2][6][2]=1;
    tile_for_level[2][6][3]=1;
    tile_for_level[2][6][4]=0;
    tile_for_level[2][6][5]=0;
    tile_for_level[2][6][6]=1;
    tile_for_level[2][6][7]=1;
    tile_for_level[2][6][8]=1;
    tile_for_level[2][6][9]=0;
    tile_for_level[2][6][10]=0;

    tile_for_level[2][7][1]=1;
    tile_for_level[2][7][2]=1;
    tile_for_level[2][7][3]=1;
    tile_for_level[2][7][4]=0;
    tile_for_level[2][7][5]=0;
    tile_for_level[2][7][6]=1;
    tile_for_level[2][7][7]=1;
    tile_for_level[2][7][8]=1;
    tile_for_level[2][7][9]=0;
    tile_for_level[2][7][10]=0;

    tile_for_level[2][8][1]=1;
    tile_for_level[2][8][2]=1;
    tile_for_level[2][8][3]=1;
    tile_for_level[2][8][4]=0;
    tile_for_level[2][8][5]=0;
    tile_for_level[2][8][6]=1;
    tile_for_level[2][8][7]=1;
    tile_for_level[2][8][8]=1;
    tile_for_level[2][8][9]=0;
    tile_for_level[2][8][10]=0;

    tile_for_level[2][9][1]=1;
    tile_for_level[2][9][2]=1;
    tile_for_level[2][9][3]=1;
    tile_for_level[2][9][4]=0;
    tile_for_level[2][9][5]=0;
    tile_for_level[2][9][6]=1;
    tile_for_level[2][9][7]=1;
    tile_for_level[2][9][8]=1;
    tile_for_level[2][9][9]=0;
    tile_for_level[2][9][10]=0;

    tile_for_level[2][10][1]=1;
    tile_for_level[2][10][2]=1;
    tile_for_level[2][10][3]=1;
    tile_for_level[2][10][4]=0;
    tile_for_level[2][10][5]=0;
    tile_for_level[2][10][6]=1;
    tile_for_level[2][10][7]=1;
    tile_for_level[2][10][8]=1;
    tile_for_level[2][10][9]=0;
    tile_for_level[2][10][10]=0;
